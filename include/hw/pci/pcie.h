...
typedef enum {
  ...
  PCI_EXP_HP_EV_SUPPORTED =
      PCI_EXP_HP_EV_ABP | PCI_EXP_HP_EV_PDC | PCI_EXP_HP_EV_CCI,
...
void pcie_cap_slot_write_config(PCIDevice *dev, uint16_t old_slt_ctl,
                                uint16_t old_slt_sta, uint32_t addr,
...
void pcie_cap_flr_write_config(PCIDevice *dev, uint32_t addr, uint32_t val,
                               int len);
...
void pcie_add_capability(PCIDevice *dev, uint16_t cap_id, uint8_t cap_ver,
