...
static __attribute__((unused)) void bios_cfg_select(uint16_t key) {
  outw(key, BIOS_CFG_IOPORT_CFG);
}

static __attribute__((unused)) void
bios_cfg_read_entry_io(void *buf, uint16_t entry, uint32_t len) {
 ...
 * ROM.
 */
static __attribute__((__noinline__)) __attribute__((unused)) void
bios_cfg_read_entry_dma(void *buf, uint16_t entry, uint32_t len) {
...
static __attribute__((unused)) void
bios_cfg_read_entry(void *buf, uint16_t entry, uint32_t len, uint32_t version) {
...
static __attribute__((unused)) uint32_t bios_cfg_version(void) {
  uint32_t version;
