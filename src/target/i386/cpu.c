...
static void encode_topo_cpuid8000001e(CPUState *cs, X86CPU *cpu, uint32_t *eax,
...
#define TCG_EXT2_FEATURES                                                      \
  ((TCG_FEATURES & CPUID_EXT2_AMD_ALIASES) | CPUID_EXT2_NX |                   \
   ...
   CPUID_EXT2_3DNOWEXT | CPUID_EXT2_PDPE1GB | TCG_EXT2_X86_64_FEATURES)
...
#define TCG_7_0_EBX_FEATURES                                                   \
  (CPUID_7_0_EBX_SMEP | CPUID_7_0_EBX_SMAP | CPUID_7_0_EBX_BMI1 |              \
   ...
   CPUID_7_0_EBX_FSGSBASE | CPUID_7_0_EBX_ERMS)
/* missing:
    ...
    [FEAT_HYPERV_EAX] =
        {
            ...
            .feat_names =
                {
                    NULL /* hv_msr_vp_runtime_access */,
                    NULL /* hv_msr_time_refcount_access */,
                    NULL /* hv_msr_synic_access */,
                    NULL /* hv_msr_stimer_access */,
                    NULL /* hv_msr_apic_access */,
                    NULL /* hv_msr_hypercall_access */,
                    NULL /* hv_vpindex_access */,
                    NULL /* hv_msr_reset_access */,
                    NULL /* hv_msr_stats_access */,
                    NULL /* hv_reftsc_access */,
                    NULL /* hv_msr_idle_access */,
                    NULL /* hv_msr_frequency_access */,
                    NULL /* hv_msr_debug_access */,
                    NULL /* hv_msr_reenlightenment_access */,
                    NULL,
                    NULL,
                    NULL,
                    NULL,
            ...
            .feat_names =
                {
                    ...
                    NULL /* hv_access_partition_id */,
                    NULL /* hv_access_memory_pool */,
                    NULL /* hv_adjust_message_buffers */,
                    NULL /* hv_post_messages */,
                    NULL /* hv_signal_events */,
                    NULL /* hv_create_port */,
                    NULL /* hv_connect_port */,
                    NULL /* hv_access_stats */,
                    NULL,
                    NULL,
                    NULL /* hv_debugging */,
                    NULL /* hv_cpu_power_management */,
                    NULL /* hv_configure_profiler */,
                    NULL,
                    NULL,
                    NULL,
                    NULL,
    ...
    [FEAT_HYPERV_EDX] =
        {
            ...
            .feat_names =
                {
                    NULL /* hv_mwait */,
                    NULL /* hv_guest_debugging */,
                    NULL /* hv_perf_monitor */,
                    NULL /* hv_cpu_dynamic_part */,
                    NULL /* hv_hypercall_params_xmm */,
                    NULL /* hv_guest_idle_state */,
                    NULL,
                    NULL,
                    NULL,
                    NULL,
                    NULL /* hv_guest_crash_msr */,
                    NULL,
                    NULL,
                    NULL,
                    NULL,
    ...
    [FEAT_7_1_EAX] =
        {
            ...
            .feat_names =
                {
                    NULL, NULL, NULL, NULL, NULL, "avx512-bf16", NULL, NULL,
    ...
    [FEAT_8000_0008_EBX] =
        {
            ...
            .feat_names =
                {
                    "clzero",    NULL,         "xsaveerptr", NULL, NULL,
                    NULL,        NULL,         NULL,         NULL, "wbnoinvd",
                    NULL,        NULL,         "ibpb",       NULL, NULL,
                    NULL,        NULL,         NULL,         NULL, NULL,
                    NULL,        NULL,         NULL,         NULL, "amd-ssbd",
                    "virt-ssbd", "amd-no-ssb", NULL,         NULL, NULL,
                    NULL,        NULL,
                },
            .cpuid =
                {
    ...
    [FEAT_XSAVE] =
        {
            ...
            .feat_names =
                {
                    "xsaveopt", "xsavec", "xgetbv1", "xsaves", NULL, NULL, NULL,
...
static void max_x86_cpu_initfn(Object *obj) {
  ...
  if (accel_uses_host_cpuid()) {
    ...
    object_property_set_str(OBJECT(cpu), CPUID_VENDOR_AMD, "vendor",
                            &error_abort);
    ...
    object_property_set_str(OBJECT(cpu),
                            "QEMU TCG CPU version " QEMU_HW_VERSION, "model-id",
                            &error_abort);
  }
...
static void host_x86_cpu_class_init(ObjectClass *oc, void *data) {
  ...
  xcc->model_description = "KVM processor with all supported host features ";
#elif defined(CONFIG_HVF)
  xcc->model_description = "HVF processor with all supported host features ";
#endif
}
...
static void x86_cpuid_version_set_family(X86CPU *cpu, int64_t value) {
  ...
  if (value < min || value > max) {
    g_assert_not_reached();
    // error_setg(errp, QERR_PROPERTY_VALUE_OUT_OF_RANGE, "", name ? name :
    // "null", value, min, max);
  }
...
static void x86_cpu_load_model(X86CPU *cpu, X86CPUModel *model) {
  ...
  cpu->env.cpuid_min_level = def->level;
  cpu->env.cpuid_min_xlevel = def->xlevel;
 ...
 */
static QDict *x86_cpu_static_props(void) { return NULL; }
...
static X86CPU *x86_cpu_from_model() {}
...
static X86CPUModel *x86_register_cpudef_types(X86CPUDefinition *def) {
  ...
  assert(m.cpudef == NULL); // x86_register_cpudef_types is only called once
  m.cpudef = def;
...
void cpu_x86_cpuid(CPUX86State *env, uint32_t index, uint32_t count,
    ...
    if (cpu->cache_info_passthrough) {
      ...
      *eax = 0;
      ...
      case 3: /* L3 cache info */
        die_offset =
            apicid_die_offset(env->nr_dies, cs->nr_cores, cs->nr_threads);
        if (cpu->enable_l3_cache) {
  ...
  case 0xB:
    ...
    *edx = cpu->apic_id;
    ...
    switch (count) {
    case 0:
      *eax = apicid_core_offset(env->nr_dies, cs->nr_cores, cs->nr_threads);
      *ebx = cs->nr_threads;
      *ecx |= CPUID_TOPOLOGY_LEVEL_SMT;
      break;
    case 1:
      *eax = apicid_pkg_offset(env->nr_dies, cs->nr_cores, cs->nr_threads);
    ...
    *edx = cpu->apic_id;
    ...
    case 0:
      ...
      *ecx |= CPUID_TOPOLOGY_LEVEL_SMT;
      break;
    case 1:
      *eax = apicid_die_offset(env->nr_dies, cs->nr_cores, cs->nr_threads);
      *ebx = cs->nr_cores * cs->nr_threads;
      *ecx |= CPUID_TOPOLOGY_LEVEL_CORE;
      break;
    case 2:
  ...
  case 0x8000001D:
    *eax = 0;
    ...
    switch (count) {
    case 0: /* L1 dcache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l1d_cache, cs, eax, ebx,
                                 ecx, edx);
      break;
    case 1: /* L1 icache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l1i_cache, cs, eax, ebx,
                                 ecx, edx);
      break;
    case 2: /* L2 cache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l2_cache, cs, eax, ebx,
                                 ecx, edx);
      break;
    case 3: /* L3 cache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l3_cache, cs, eax, ebx,
                                 ecx, edx);
      break;
    default: /* end of info */
      *eax = *ebx = *ecx = *edx = 0;
...
void x86_cpu_realizefn(X86CPU *cpu) {
  ...
  if (env->features[FEAT_8000_0001_EDX] & CPUID_EXT2_LM) {
    if (accel_uses_host_cpuid()) {
       ...
       * host value.
       */
      if (cpu->phys_bits != host_phys_bits && cpu->phys_bits != 0 && !warned) {
 ...
 */
static void x86_cpu_register_bit_prop(X86CPU *cpu, const char *prop_name,
  ...
  if (op) {
    ...
    fp->w = w;
    fp->mask = mask;
    object_property_add(OBJECT(cpu), prop_name, "bool", x86_cpu_get_bit_prop,
                        x86_cpu_set_bit_prop, x86_cpu_release_bit_prop, fp,
                        &error_abort);
  }
}

static void x86_cpu_register_feature_bit_props(X86CPU *cpu, FeatureWord w,
                                               int bitnr) {
  FeatureWordInfo *fi = &feature_word_info[w];
...
static void x86_cpu_initfn(X86CPU *cpu) {
  ...
  object_property_add(obj, "stepping", "int", x86_cpuid_version_get_stepping,
                      x86_cpuid_version_set_stepping, NULL, NULL, NULL);
  object_property_add_str(obj, "vendor", x86_cpuid_get_vendor,
...
static void x86_disas_set_info(CPUState *cs, disassemble_info *info) {
  ...
  info->cap_mode = (env->hflags & HF_CS64_MASK
                        ? CS_MODE_64
                        : env->hflags & HF_CS32_MASK ? CS_MODE_32 : CS_MODE_16);
...
static const TypeInfo qemu32_cpu = {
    .name = typename,
    .parent = TYPE_X86_CPU,
    .class_init = x86_cpu_cpudef_class_init,
};
