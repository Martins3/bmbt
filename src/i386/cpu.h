...
//#define xtm_fpu_top_out_valid(x) (((x) & XTM_FPU_TB_TOP_OUT_V_MASK) >> XTM_FPU_TB_TOP_OUT_V)
//#define xtm_fpu_top_in_valid(x)  (((x) & XTM_FPU_TB_TOP_IN_V_MASK)  >> XTM_FPU_TB_TOP_IN_V) 
//#define xtm_fpu_get_top_out(x)   (((x) & XTM_FPU_TB_TOP_OUT_MASK) >> XTM_FPU_TB_TOP_OUT)
//#define xtm_fpu_get_top_in(x)    (((x) & XTM_FPU_TB_TOP_IN_MASK)  >> XTM_FPU_TB_TOP_IN) 
//#define xtm_fpu_set_top_out(x,o) (((x) & ~XTM_FPU_TB_TOP_OUT_MASK) | (((o) & 7) << XTM_FPU_TB_TOP_OUT) | XTM_FPU_TB_TOP_OUT_V_MASK)
//#define xtm_fpu_set_top_in(x,i)  (((x) & ~XTM_FPU_TB_TOP_IN_MASK)  | (((i) & 7) << XTM_FPU_TB_TOP_IN)  | XTM_FPU_TB_TOP_IN_V_MASK)
//#define xtm_fpu_clr_top_out(x)   ((x) & ~XTM_FPU_TB_TOP_OUT_MASK & ~XTM_FPU_TB_TOP_OUT_V_MASK)
//#define xtm_fpu_clr_top_in(x)    ((x) & ~XTM_FPU_TB_TOP_IN_MASK  & ~XTM_FPU_TB_TOP_IN_V_MASK)
