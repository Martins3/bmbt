...
void fp_init(void)
{
    lsassertm(0, "flag pattern to be implemented in LoongArch.\n");
...
//{
//    int pir1_index =
//        pir1 - etb_ir1_inst_first(lsenv->tr_data->curr_tb->extra_tb);
...
//    ETB *petb = lsenv->tr_data->curr_tb->extra_tb;
//    lsassert(petb != NULL);
...
//        append_ir2_opnd2i(mips_sll, &save_src0, &src0, sll_value);
...
//            append_ir2_opnd2i(mips_sll, &save_src1, &src1, sll_value);
//        else
//            load_imm32_to_ir2(&save_src1, ir2_opnd_imm(&src1) << sll_value,
//                                 SIGN_EXTENSION);
...
//            append_ir2_opnd2i(mips_sll, &save_dest, &dest, sll_value);
...
//    case CMP_JA:
//    case SUB_JA:
//        append_ir2_opnd3(mips_sltu, &condition, &src1, &src0);
//        append_ir2_opnd3(mips_bne, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JBE:
//    case SUB_JBE:
//        append_ir2_opnd3(mips_sltu, &condition, &src1, &src0);
//        append_ir2_opnd3(mips_beq, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JB:
//    case SUB_JB:
//        append_ir2_opnd3(mips_sltu, &condition, &src0, &src1);
//        append_ir2_opnd3(mips_bne, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JAE:
//    case SUB_JAE:
...
//        break;
//    case ADD_JAE:
//        append_ir2_opnd3(mips_addu, &src0, &src0, &src1);
//        append_ir2_opnd3(mips_sltu, &condition, &src0, &src1);
//        append_ir2_opnd3(mips_beq, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case ADD_JB:
...
//    case CMP_CMOVA:
//    case SUB_CMOVA:
//        append_ir2_opnd3(mips_sltu, &provided_opnd2, &src1, &src0);
//        append_ir2_opnd2i(mips_xori, &provided_opnd2, &provided_opnd2, 1);
//        break;
//    case CMP_CMOVBE:
//    case SUB_CMOVBE:
//        append_ir2_opnd3(mips_sltu, &provided_opnd2, &src1, &src0);
...
//    case CMP_CMOVB:
//    case SUB_CMOVB:
//        append_ir2_opnd3(mips_sltu, &provided_opnd2, &src0, &src1);
//        break;
//    case CMP_CMOVAE:
//    case SUB_CMOVAE:
//        append_ir2_opnd3(mips_sltu, &provided_opnd2, &src0, &src1);
...
//    case CMP_JG:
//    case SUB_JG:
//        append_ir2_opnd3(mips_slt, &condition, &src1, &src0);
//        append_ir2_opnd3(mips_bne, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JLE:
//    case SUB_JLE:
...
//    case CMP_JL:
//    case SUB_JL:
//        append_ir2_opnd3(mips_slt, &condition, &src0, &src1);
//        append_ir2_opnd3(mips_bne, &condition, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JGE:
//    case SUB_JGE:
...
//    case CMP_CMOVG:
//    case SUB_CMOVG:
//        append_ir2_opnd3(mips_slt, &provided_opnd2, &src1, &src0);
//        append_ir2_opnd2i(mips_xori, &provided_opnd2, &provided_opnd2, 1);
//        break;
//    case CMP_CMOVLE:
//    case SUB_CMOVLE:
...
//    case CMP_CMOVL:
//    case SUB_CMOVL:
//        append_ir2_opnd3(mips_slt, &provided_opnd2, &src0, &src1);
//        break;
//    case CMP_CMOVGE:
//    case SUB_CMOVGE:
//        append_ir2_opnd3(mips_slt, &provided_opnd2, &src0, &src1);
...
//    case OR_JG:
//    case AND_JG:
//        append_ir2_opnd2(mips_bgtz, &dest, &provided_opnd2);
//        break;
//    case TEST_JLE:
//    case OR_JLE:
//    case AND_JLE:
//        append_ir2_opnd2(mips_blez, &dest, &provided_opnd2);
//        break;
//    case TEST_JL:
//    case OR_JL:
//    case AND_JL:
//        append_ir2_opnd2(mips_bltz, &dest, &provided_opnd2);
//        break;
//    case TEST_JGE:
//    case OR_JGE:
//    case AND_JGE:
//        append_ir2_opnd2(mips_bgez, &dest, &provided_opnd2);
//        break;
//    default:
//        /* env->tr_data->curr_tb->dump(); */
//        /* lsassertm(0, "flag pattern %s_%s not implemented\n", */
...
//        case X86_INS_CMP:
//        case X86_INS_SUB:
//            append_ir2_opnd3(mips_subu, &dest, &src0, &src1);
//            break;
//        case X86_INS_ADD:
//        case X86_INS_INC:
//            append_ir2_opnd3(mips_addu, &dest, &src0, &src1);
//            break;
//        default:
...
//    case CMP_JZ:
//    case SUB_JZ:
//        append_ir2_opnd3(mips_beq, &dest, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JNZ:
//    case SUB_JNZ:
//        append_ir2_opnd3(mips_bne, &dest, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JS:
//    case SUB_JS:
//        append_ir2_opnd2i(mips_srl, &dest, &dest, 31);
//        append_ir2_opnd3(mips_bne, &dest, &zero_ir2_opnd, &provided_opnd2);
//        break;
//    case CMP_JNS:
//    case SUB_JNS:
...
//    case CMP_CMOVZ:
//    case SUB_CMOVZ:
//        append_ir2_opnd2i(mips_sltiu, &provided_opnd2, &dest, 1);
//        break;
//    case CMP_CMOVNZ:
//    case SUB_CMOVNZ:
//        append_ir2_opnd2i(mips_sltiu, &provided_opnd2, &dest, 1);
...
//    case CMP_CMOVS:
//    case SUB_CMOVS:
//        append_ir2_opnd2i(mips_srl, &provided_opnd2, &dest, 31);
//        break;
//    case CMP_CMOVNS:
//    case SUB_CMOVNS:
//        append_ir2_opnd2i(mips_srl, &provided_opnd2, &dest, 31);
...
//    case CMP_SETNZ:
//    case SUB_SETNZ:
//        append_ir2_opnd3(mips_sltu, &provided_opnd2, &zero_ir2_opnd, &dest);
//        break;
//    case TEST_SETZ:
//    case OR_SETZ:
//    case AND_SETZ:
