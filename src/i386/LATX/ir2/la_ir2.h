...
typedef IR2_INS_TYPE IR2_OPCODE;
...
typedef enum IR2_OPND_TYPE {
    ...
    IR2_OPND_MEM,   /* ONLY to simplify the process of memory
                       NOT used during assembling */
} IR2_OPND_TYPE;

typedef struct IR2_OPND {
    IR2_OPND_TYPE _type;
    int val;
    int imm; /* used for MEM's offet ONLY! */
} IR2_OPND;
