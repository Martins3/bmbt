...
#define CONFIG_XTM_CAPSTONE

#ifdef CONFIG_XTM_CAPSTONE

#define XTM_INST_MAX 512
...
CAPSTONE_EXPORT
size_t CAPSTONE_API xtm_disasm_x86(csh handle,
		const uint8_t *code, size_t code_size,
		uint64_t address,
		size_t count,
		cs_insn **insn);

void *xtm_alloc_cs_insn(void);
void *xtm_alloc_cs_detail(void);
void xtm_free_cs_insn(void*);
void xtm_free_cs_detail(void*);

void xtm_reset_capstione_mem(void);
