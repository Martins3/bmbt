 ...
 */
static inline void tlbinv(void) { __asm__ __volatile__("tlbclr"); }

static inline void tlbinvf(void) { __asm__ __volatile__("tlbflush"); }
...
static inline void guest_tlbinvf(void) {
  __asm__ __volatile__(".word 0x6482401\n\t");
}
...
static inline void guest_tlb_probe(void) {
  __asm__ __volatile__(".word 0x6482801\n\t");
}

static inline void guest_tlb_read(void) {
  __asm__ __volatile__(".word 0x6482c01\n\t");
}

static inline void guest_tlb_write_indexed(void) {
  __asm__ __volatile__(".word 0x6483001\n\t");
}

static inline void guest_tlb_write_random(void) {
  __asm__ __volatile__(".word 0x6483401\n\t");
}
...
static inline void invtlb_noaddr(u32 op, u32 info, u64 addr) {
  __asm__ __volatile__("parse_r info,%0\n\t"
